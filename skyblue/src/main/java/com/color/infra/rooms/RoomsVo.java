...
public class RoomsVo {
	...
	public Integer getShRooms_delNy() {
		return shRooms_delNy;
	}

	public void setShRooms_delNy(Integer shRooms_delNy) {
		this.shRooms_delNy = shRooms_delNy;
	}
